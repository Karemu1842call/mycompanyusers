        ...
        <div className="p-4 border border-gray-300 rounded-lg">
          ...
          <div className="flex flex-col items-start mb-4">
            <p className="text-stone-900 font-bold">
              <span className="font-semibold">Name:</span> {item.user.first_name} {item.user.last_name}
            </p>
            <p className="text-stone-900 font-bold">
              <span className="font-semibold">Personal ID:</span> {item.personal_id}
            </p>
            <p className="text-stone-900 font-bold">
              <span className="font-semibold">Phone Number:</span> {item.phone_no}
            </p>
            <p className="text-stone-900 font-bold">
              <span className="font-semibold">Gender:</span> {item.gender}
            </p>
            <p className="text-stone-900 font-bold">
              <span className="font-semibold">Marital Status:</span> {item.marital_status}
            </p>
          </div>
